/*
  # Fix User Cycle RPC Function Syntax

  1. RPC Functions
     - Create corrected `ap_create_user_cycle` function with proper SQL syntax
     - Fix single quote issues in CASE statements

  2. Views
     - Create corrected `v_user_cycle_weeks` view with proper syntax
     - Create `v_user_cycle_days_left` view for days remaining calculation

  3. Security
     - Grant proper permissions to authenticated users
*/

-- Create the user cycle creation RPC function with corrected syntax
