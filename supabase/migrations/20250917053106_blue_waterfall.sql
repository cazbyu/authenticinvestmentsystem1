/*
  # Create Unified Timeline Views (Fixed)

  1. New Views
     - `v_unified_timeline_weeks` - Combines global and custom timeline weeks with correct columns
     - `v_unified_timeline_days_left` - Combines global and custom timeline days left with correct columns
...
-- Create unified timeline weeks view with correct column names
...
-- Create unified timeline days left view with correct column names
