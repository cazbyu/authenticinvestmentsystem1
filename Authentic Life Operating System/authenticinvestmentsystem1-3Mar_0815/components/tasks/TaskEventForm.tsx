...
export default function TaskEventForm({ 
  ...
  // Advanced section toggle - collapsed by default for simpler form
  ...
  // Auto-expand Advanced section when editing a task that has advanced fields populated
  useEffect(() => {
    if (mode === 'edit' && initialData) {
      const hasAdvancedData =
        initialData.recurrence_rule ||
        initialData.is_urgent ||
        initialData.is_important ||
