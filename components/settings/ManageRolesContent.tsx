...
// Interfaces
interface ManageRolesContentProps {
  onUpdate?: () => void;
  onDataLoaded?: () => void;
}
...
export function ManageRolesContent({ onUpdate, onDataLoaded }: ManageRolesContentProps) {
    ...
    <ScrollView style={styles.container}>
      {loading ? (
        ...
        <View style={styles.content}>
          ...
          ) : <Text style={styles.noDataText}>No preset roles found.</Text>}
